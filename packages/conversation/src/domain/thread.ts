...
export interface ThreadSummary { id: ThreadId; title: string; model: string; reasoningEffort: string; cwd: string; gitBranch?: string; updatedAt?: number; contextUsed?: number; contextLimit?: number; status: "idle" | "working" | "blocked" | "disconnected" }
