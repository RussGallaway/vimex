...
export interface ThreadSummary { goal?: import("./thread-goal").ThreadGoal | null; id: ThreadId; title: string; model: string; reasoningEffort: string; cwd: string; gitBranch?: string; updatedAt?: number; contextUsed?: number; contextLimit?: number; status: "idle" | "working" | "blocked" | "disconnected" }
