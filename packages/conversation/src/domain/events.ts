...
export type ConversationEvent =
  | { type: "turn.started"; threadId: ThreadId; turnId: TurnId; startedAt?: number }
  | { type: "turn.completed"; threadId: ThreadId; turnId: TurnId; outcome: TurnOutcome; startedAt?: number; completedAt?: number; durationMs?: number }
