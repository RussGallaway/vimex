...
export interface PaneGeometry { width: number; height: number; x: number; y: number }
export const PaneGeometryContext = createContext<PaneGeometry | undefined>(undefined)
