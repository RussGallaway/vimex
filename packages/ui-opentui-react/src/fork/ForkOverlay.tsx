...
export function ForkOverlay(props: {
  pending?: WorkbenchState["pendingFork"]
}) {
  return (
    <OverlayFrame title="Fork session" width={84}>
      {props.pending ? (
        <>
          <text fg={emberTide.amber}>
            <b>
              Create a new session through the completed turn beginning with
              this message?
            </b>
          </text>
          <box
          ...
          >
            <text fg={emberTide.textSoft} wrapMode="word">
              {props.pending.preview}
            </text>
          </box>
