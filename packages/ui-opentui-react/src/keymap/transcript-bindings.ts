...
export function transcriptBindings(ctx: VimBindingContext): UiBinding[] {
  ...
  return [
    { key: "w", cmd: () => semantic("word-next") },
    { key: "b", cmd: () => semantic("word-previous") },
    { key: "e", cmd: () => semantic("word-end") },
    { key: "shift+w", cmd: () => semantic("WORD-next") },
    { key: "shift+b", cmd: () => semantic("WORD-previous") },
    { key: "shift+e", cmd: () => semantic("WORD-end") },
    { key: "shift+[", cmd: () => semantic("block-previous") },
    { key: "shift+]", cmd: () => semantic("block-next") },
    { key: "{", cmd: () => semantic("block-previous") },
    { key: "}", cmd: () => semantic("block-next") },
    { key: "[[", cmd: () => semantic("message-previous") },
    { key: "]]", cmd: () => semantic("message-next") },
    { key: "[u", cmd: () => semantic("url-previous") },
    { key: "]u", cmd: () => semantic("url-next") },
    ...
    { key: "h", cmd: () => ctx.countedMotion("left") },
    { key: "j", cmd: () => ctx.countedMotion("down") },
    { key: "k", cmd: () => ctx.countedMotion("up") },
    { key: "l", cmd: () => ctx.countedMotion("right") },
    {
      key: "0",
      cmd: () =>
        ctx.countRef.current
          ? (() => {
              ctx.countRef.current = `${ctx.countRef.current}0`.slice(0, 4)
              ctx.controller.dispatchInteraction({
                type: "count.push",
                digit: 0,
              })
            })()
          : ctx.countedMotion("line-start"),
    },
    { key: "$", cmd: () => ctx.countedMotion("line-end") },
    { key: "gg", cmd: () => ctx.countedMotion("first") },
    {
      key: "shift+g",
      cmd: () => {
        ctx.dispatchMotion("last")
